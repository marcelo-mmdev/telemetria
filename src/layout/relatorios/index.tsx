...
import RelatorioCompletoPlanilha from "@/components/relatorios/relatorioCompletoPlanilha";
...
export default function Relatorios({ children }: { children: ReactNode }) {
